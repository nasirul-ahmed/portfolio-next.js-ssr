...
export function ThemeToggle() {
  ...
  return (
    <div className='relative bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 rounded-full shadow-inner'>
      ...
      <div className='relative flex gap-1 justify-center items-center'>
        {themes.map(({ name, icon: Icon, label }) => (
          <button
            ...
            onMouseEnter={() => canHover && setHoveredTheme(name)}
            onMouseLeave={() => canHover && setHoveredTheme(null)}
            className='group relative p-2 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95 focus:outline-none'
          ...
          >
            ...
            >
              <Icon size={20} className={`${getIconColor(name)} transition-colors duration-200`} />
            </div>
