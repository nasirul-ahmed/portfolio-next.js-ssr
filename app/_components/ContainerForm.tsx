    ...
    <form onSubmit={handleSubmit} className='space-y-12'>
      <div className='space-y-8'>
        ...
        <div className='space-y-2'>
          <label htmlFor='name' className='text-sm font-medium text-gray-500 dark:text-gray-400'>
            Name *
          </label>
          <input
            type='text'
        ...
        <div className='space-y-2'>
          ...
          <input
            ...
            value={form.email}
            onChange={handleChange}
            placeholder='nasirul@example.com'
            className={inputClasses}
            required
            disabled={loading}
          />
        ...
        {/* Message */}
        <div className='space-y-2'>
          <label htmlFor='message' className='text-sm font-medium text-gray-500 dark:text-gray-400'>
            Message *
          </label>
          <textarea
            id='message'
