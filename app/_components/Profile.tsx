...
function Profile() {
  ...
  return (
    <div className='relative w-full mx-auto mt-30'>
      <div className='absolute overflow-hidden top-1 left-1/2 -translate-x-1/2 -translate-y-1/2 w-38 h-38 md:w-46 md:h-46 rounded-full border-4 border-white dark:border-gray-800 z-10'>
        <Image
          ...
          priority
          src={ProfileImage}
          alt={config.name + ' Full stack developer profile picture'}
          className='object-cover'
          fill
        />
      </div>
      <div className='bg-white dark:bg-black text-center rounded-2xl px-8 lg:px-4 pt-24 pb-6 shadow-xl border border-gray-100 dark:border-gray-700'>
        <h2 className='text-xl font-bold text-gray-800 dark:text-white'>{config.name}</h2>
        ...
        >
          <IconMap.FaDownload /> Download Resume
        </a>
